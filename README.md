...
| <a name="input_run_trigger_auto_apply"></a> [run\_trigger\_auto\_apply](#input\_run\_trigger\_auto\_apply) | Boolean to automatically apply a Run when triggered. | `bool` | `false` | no |
